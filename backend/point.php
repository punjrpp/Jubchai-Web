...
<body>
    <div class="container text-center">
        ...
        <hr>
        <table id="pointTable" class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    <td>UUID</td>
                    <td>IGN</td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php $point = $row['point_web']; echo number_format("$point"); ?></td>
                    <td><a href="point_edit.php?update_id=<?php echo $row['UUID']; ?>" class="badge bg-warning">Edit</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>

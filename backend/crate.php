<?php 
    ...
    if (isset($_REQUEST['delete_id'])) {
        ...
        $delete_stmt = $db->prepare('DELETE FROM crate WHERE id = :id');
...
<body>
    ...
    <div class="container text-center">
        ...
        <a href="crate_add.php" class="btn btn-success">Add+</a>
        <hr>
        ...
        <table id="annTable" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <?php 
                    $select_stmt = $db->prepare('SELECT * FROM crate'); 
                    $select_stmt->execute();
                ...
                <tr>
                    ...
                    <td><?php echo $row['droprate']; ?></td>
                    <td><?php echo $row['crateid']; ?></td>
                    <td><a href="crate_edit.php?update_id=<?php echo $row['id']; ?>" class="badge bg-warning">Edit</a> <a href="?delete_id=<?php echo $row['id']; ?>" class="badge bg-danger">Delete</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>

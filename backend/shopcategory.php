<?php 
    ...
    if (isset($_REQUEST['delete_id'])) {
        ...
        $delete_stmt = $db->prepare('DELETE FROM shopcategory WHERE id = :id');
...
<body>
    ...
    <div class="container text-center">
        ...
        <a href="shopcategory_add.php" class="btn btn-success">Add+</a>
        <hr>
        ...
        <table id="annTable" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <?php 
                    $select_stmt = $db->prepare('SELECT * FROM shopcategory'); 
                    $select_stmt->execute();
                ...
                <tr>
                    ...
                    <td><?php echo $row['buyicon']; ?></td>
                    <td><?php echo $row['sellicon']; ?></td>
                    <td><?php echo $row['quest']; ?></td>
                    <td><?php echo $row['displayname']; ?></td>
                    <td><a href="shopcategory_edit.php?update_id=<?php echo $row['id']; ?>" class="badge bg-warning">Edit</a> <a href="?delete_id=<?php echo $row['id']; ?>" class="badge bg-danger">Delete</a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>

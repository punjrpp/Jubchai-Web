...
<body>
    ...
    <br>
    <!-- Photo -->
    <img width="1080px" src="../img/ปก transparent.png" alt="jccommunity">
    <br>
    <br>
    <br>
    <img width="1080px" src="../img/rule transparent.png" alt="jccommunityrule">
    <br>
    <br>
    <br>
    <img width="1080px" src="../img/how to play transparent.png" alt="jccommunityhtp">
    <br>
    <br>
    <br>
    <img width="1080px" src="../img/crafting transparent1.png" alt="jccommunitycraft">
